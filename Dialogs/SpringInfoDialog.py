...
else:  # pragma: no cover - executed only when PySide is unavailable
    raise ImportError("Spring workbench requires PySide6 or PySide2 to show dialogs")
...
class SpringInfoDialog(QtWidgets.QDialog):
    ...
    def _populate_table(self):
        ...
        for i, obj in enumerate(self.objs):
            ...
            wire_len = Utils.spring_wire_length(outer_d, pitch, total_coils)
